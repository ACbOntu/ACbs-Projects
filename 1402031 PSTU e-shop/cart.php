      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $mysqli->query("SELECT product_code, product_name, product_desc, qty, price FROM cse WHERE id = ".$product_id);
          ...
          if(isset($_SESSION['email'])) {
            echo '<a href="orders-update.php"><button style="float:right;">Go</button></a>';
          }
